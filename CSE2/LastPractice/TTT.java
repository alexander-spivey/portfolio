...
public class TTT
{
	...
	public static void print2dMatrix(String[][] A)
	{
		for(int i = 0; i < A.length; i++)
		{
			for(int j = 0; j < A[i].length; j++)
	...
	public static void computerMove(String[][] A)
	{
	...
	public static boolean pcCheck(String[][] A)
	{
		if(A[0][0].equals("X"))
		{
			if(A[0][1].equals("X"))
	...
	public static void yourMove(String[][] A)
	{
	...
	public static boolean playerCheck(String[][] A)
	{
		if(A[0][0].equals("O"))
		{
			if(A[0][1].equals("O"))
	...
	public static boolean empty(String[][] A, int i, int j)
	{
		if(A[i][j] == " ")
		{
			return true;
	...
	public static void pcAi(String[][] A)
	{
		System.out.println("Computer's Move");
		Random rand = new Random();
		boolean c = false;
